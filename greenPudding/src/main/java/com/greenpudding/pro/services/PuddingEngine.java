...
import com.greenpudding.lib.R;
import com.greenpudding.lib.model.Pudding;
import com.greenpudding.lib.model.RenderMode;
import com.greenpudding.lib.thread.PuddingRenderer;

/**
 * This implements the actual live wallpaper
 * 
 */
class PuddingEngine extends WallpaperService.Engine implements SensorEventListener,
	...
	public PuddingEngine(GreenPuddingWallpaperService wallpaperService) {
