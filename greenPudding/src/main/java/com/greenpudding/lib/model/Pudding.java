...
public class Pudding {
	...
	private static final double DEFAULT_BINDING_ELASTICITY = 10f;
	private static final double DEFAULT_PINNING_ELASTICITY = 0.1f;
	private static final double DEFAULT_DAMPING_FACTOR = 0.8f;
	private static final int DEFAULT_RADIUS = 100;
	private static final int DEFAULT_NUM_NODES = 12;
	private static final int DEFAULT_FILL_COLOR = 0xFF9FD867;
	...
	// Essential attributes of the pudding model
	// number of nodes
	 ...
	 * 
	 * @param refreshNodes
	 *            :whether to auto refresh all the nodes's status after
	 *            initialization. If no, must manually call refreshNodes()
	 *            before rendering
	 */
	public Pudding() {
		init();
	...
	private void init() {
		...
		interpolatedNodes = new Vector2d[MAX_NODE_NUM];
	...
	/**
	 * Set the number of nodes and update other attributes
	 * 
	 * @param numOfNodes
	 */
	...
	private void renderWireFrame(Canvas canvas) {
	 ...
	 * @param radius
	 * @param refreshNodes
	 *            : whether to refresh the position of all nodes
	 */
